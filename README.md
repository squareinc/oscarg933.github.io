...
You can use the [editor on GitHub](https://github.com/oscarg933/oscarg933.github.io/edit/master/README.md) to maintain and preview the content for your website in Markdown files.
...
AutomatedLab is a provisioning solution and framework that lets you deploy complex labs on HyperV and Azure with simple PowerShell scripts. It supports all Windows operating systems from 2008 R2 to 2016 including Nano Server and various products like AD, Exchange, PKI, IIS, etc. https://github.com/oscarg933/lawyerso…
 ...
 Pull request   Compare This branch is 59 commits ahead, 98 commits behind AutomatedLab:develop.
@oscarg933
oscarg933 Add files via upload
Latest commit 3c9b35e  just now
...
AutomatedLabUnattended	Enclosed PW in '' to ensure all possible special chars are taken care of	3 months ago
AutomatedLabWorker	Cleanup	2 months ago
Help	Renamed 'Get / Set-MachineUacStatus' to 'Get / Set-VMUacStatus' and f…	5 months ago
HostsFile	Version Number = 4.5.7.0	a year ago
Installer	Added 'SetupDscPullServerSql.ps1'	2 months ago
LabSources	Create Lbry.io	a month ago
LabXml	Merge branch 'develop' of https://github.com/AutomatedLab/AutomatedLab …	2 months ago
META-INF	Add files via upload	just now
...
TestClient	Release 5.0.0.* (AutomatedLab#286)	9 months ago
Tests	AppVeyor integration added	a year ago
amazon/communication	Add files via upload	just now
assets	Add files via upload	just now
https/github.com/oscarg933	Create release.git.patch	4 days ago
res	Add files via upload	just now
'iota.patch'	Create 'iota.patch'	17 days ago
.gitattributes	Initial	2 years ago
.gitignore	Initial	2 years ago
.gitmodules	Added submodule AutomatedLab.Common	a year ago
.iot	Update .iot	20 days ago
.iota	Create .iota	a month ago
0101010102010010101011010	Create 0101010102010010101011010	7 days ago
07d709a412b74db7fa35017d12291b72-35ee6ee3a7a526f33981e1e024656a2b9b30505d.zip	Add files via upload	4 days ago
365sharepoint.engineer	Create 365sharepoint.engineer	a month ago
3dprinterpenrosgod.ros	Create 3dprinterpenrosgod.ros	4 days ago
<com.amazon.device.logmanager>.apk	Add files via upload	just now
AIS3-2017-master.zip	.iot	a month ago
Account Management veneno.iot (1).pdf	Add files via upload	20 days ago
AndroidManifest.xml	Add files via upload	just now
AutomatedLab-develop 5.zip	Add files via upload	9 days ago
AutomatedLab.sln	Merge pull request AutomatedLab#486 from AutomatedLab/fix/PSConfAsiaCi	2 months ago
BinarySerializer-master 2 2 2 3.zip	Add files via upload	9 days ago
Block.info	Create Block.info	a month ago
...
CloudFusion-master.zip	Add files via upload	8 days ago
Codecov.io.appveyor.yml	Create Codecov.io.appveyor.yml	17 days ago
Creative Overview jenkins.io.pdf	Add files via upload	20 days ago
Creative Overview veneno.iot.pdf	Add files via upload	20 days ago
DeepWebLinks-master.zip	Add files via upload	9 days ago
Direct Deposit Form Oscar Gomez jenkins.io.pdf	Add files via upload	20 days ago
Direct Deposit Sign Up | Green Dot Prepaid Debit Cards.patch.md.pdf	Add files via upload	9 days ago
DirectDepositApp-master.zip	Add files via upload	a month ago
GitHub veneno.iot.pdf	Add files via upload	19 days ago
HackatonSinaloa2018-master.zip	Add files via upload	9 days ago
Jenkins.io	Create Jenkins.io	17 days ago
LICENSE	Release 5.0.0.* (AutomatedLab#286)	9 months ago
Layer	Create Layer	a month ago
Legal	Create Legal	a month ago
Marketplace · Tools to improve your workflow dio.ros.pdf	Add files via upload	19 days ago
Octo.psm2	Create Octo.psm2	a month ago
Oscarg933.github.io	Update Oscarg933.github.io	a month ago
PyPattyrn-master.zip	Add files via upload	a month ago
PyPlanet-master.zip	Add files via upload	9 days ago
README.md	Update README.md	18 days ago
RS=nyDrtXHCnj7pMus1m9eURYlUSJs-;_ylt=AwrWp2futPJbfGMA4zlEDN04;_ylu=X3oDMTB2cTU4a2RyBGNvbG8DZ3ExBHBvcwM0BHZ0aWQDBHNlYwNvdi10b3A-;_ylc=X3IDMgRydAMx.dms	Add files via upload	9 days ago
Splatnet2-Rich-Presence-master.zip	Add files via upload	8 days ago
SwiftTools-master (1).zip	Add files via upload	a month ago
SwiftTools-master.zip	Add files via upload	a month ago
UltimateAscent-master.zip	Add files via upload	a month ago
Veneno.iot	Update Veneno.iot	17 days ago
Veneno.ros.live	Create Veneno.ros.live	2 days ago
Win32-OpenSSH-L1-Prod.zip	Add files via upload	a month ago
_config.yml	Add files via upload	9 days ago
akaunting-1.3-dev.zip	Add files via upload	9 days ago
ancestry-master.iot.zip	Add files via upload	9 days ago
api.openload.co.iot.pdf	Add files via upload	20 days ago
...
azure-pipelines.yml	Set up CI with Azure Pipelines	2 months ago
binaryninja-api-dev.zip	Add files via upload	a month ago
docker-mailserver-master.zip	Add files via upload	8 days ago
github-dorks-master.zip	Add files via upload	4 days ago
jailbreak-master.zip	Add files via upload	8 days ago
maxprofs	Update maxprofs	2 months ago
pandora-master.zip	Add files via upload	8 days ago
polaris-react-master.zip	Add files via upload	a month ago
psake.ps1	Updated AppVeyor.yml to directly publish nuget packages	11 months ago
rails-master.zip	Add files via upload	9 days ago
rclone-v1.45-solaris-amd64.zip	Add files via upload	9 days ago
resources.arsc	Add files via upload	just now
upgraded-adventure-master.zip	Add files via upload	a month ago
veneno.iot (7).pdf	Add files via upload	19 days ago
 README.md
AutomatedLab
...
azure-pipelines.yml | 30 ++++++++++++++++++++++++++++++ 1 file changed, 30 insertions(+) create mode 100644 azure-pipelines.yml
...
From 784d432c2010606d8466e82787680afb9392c0c8 Mon Sep 17 00:00:00 2001 From: Oscar Gomez 42280574+oscarg933@users.noreply.github.com Date: Fri, 9 Nov 2018 08:40:27 -0700 Subject: [PATCH 5/9] Update issue templates
...
From aeb8d1d5aa3f47f8ed329d4142a3ae432464df54 Mon Sep 17 00:00:00 2001 From: Oscar Gomez 42280574+oscarg933@users.noreply.github.com Date: Fri, 9 Nov 2018 09:31:27 -0700 Subject: [PATCH 7/9] Create Oscarg933.github.io
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/oscarg933/oscarg933.github.io/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
